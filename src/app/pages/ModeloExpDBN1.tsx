    ...
    <div className="space-y-8 slide-in-up">
        ...
        <div className="relative flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-[#666666]">
              Exporte modelos de relacionamento DBN1 com classes e schemas
              customizados
            </p>
          </div>
        </div>
      ...
      <div className="modern-card p-8">
        <div className="space-y-8">
          ...
          <div>
            <label className="block text-sm font-bold text-[#333333] mb-4 flex items-center gap-2">
              <FileEdit className="w-5 h-5 text-[#0099AB]" />
              Nome do Inventário
            </label>
            <textarea
              value={inventoryName}
              onChange={(e) => setInventoryName(e.target.value)}
              placeholder="Digite os nomes dos inventários DBN1 (um por linha)..."
          ...
          <div>
            ...
            <input
              ...
              placeholder="Digite o nome da classe (exemplo: ClassePedido)..."
              className="w-full px-4 py-3 border-1.5 border-[#e0e0e0] rounded-lg text-[#333333] placeholder-[#999999] focus:outline-none focus:ring-2 focus:ring-[#0099AB] focus:border-transparent transition-all bg-white/50 hover:bg-white"
            />
          </div>
        </div>
        ...
        <div className="flex gap-3">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-[#666666]">
              <li>
                <strong className="text-[#333333]">Caminho:</strong> Defina onde
                você deseja salvar os arquivos DBN1 exportados
              </li>
              <li>
                <strong className="text-[#333333]">Inventários:</strong> Liste
                todos os inventários DBN1 necessários, cada um em uma nova linha
              </li>
              <li>
                <strong className="text-[#333333]">Schema:</strong> Especifique
                o schema do banco de dados para acesso correto aos dados
              </li>
              <li>
                <strong className="text-[#333333]">Classe:</strong> Defina o
                nome lógico da classe para identificação na exportação
              </li>
            </ul>
          </div>
        </div>
